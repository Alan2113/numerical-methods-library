...
void testujEliminacjeGaussa() {
    ...
    // Test 1: Prosty uk³ad 2x2
    std::cout << "\nTest 1: Uk³ad 2x2" << std::endl;
    ...
    std::cout << "Rozwi¹zanie: x = " << rozwiazanie1[0] << ", y = " << rozwiazanie1[1] << std::endl;
    ...
    std::cout << "Rozwi¹zanie: x = " << rozwiazanie2[0]
        << ", y = " << rozwiazanie2[1]
    ...
    // Test 3: Weryfikacja rozwi¹zania
    std::cout << "\nTest 3: Weryfikacja rozwi¹zania" << std::endl;
    ...
    std::cout << "Sprawdzenie równañ:" << std::endl;
    std::cout << "Równanie 1: " << sprawdzenie1 << " = " << b2[0] << std::endl;
    std::cout << "Równanie 2: " << sprawdzenie2 << " = " << b2[1] << std::endl;
    std::cout << "Równanie 3: " << sprawdzenie3 << " = " << b2[2] << std::endl;
    ...
    std::cout << "\n=== WSZYSTKIE TESTY ELIMINACJI GAUSSA PRZESZ£Y! ===" << std::endl;
}